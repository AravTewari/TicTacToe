...
public class Main
{
    ...
    static char[][] fillTable(char[][] arr, String input) /** fills the whole matrix by the String put by the user **/
    {
        int counter = 0;
        for(int i = 0; i < 3; i++)
        {
    ...
    static char[][] ninetyRight(char[][] arr) /** rotates matrix to 90 degrees right **/
    {
    ...
    static char[][] ninetyLeft(char[][] arr) /** rotates matrix to 90 degrees left **/
    { // rotates matrix to 90 degree left
        for(int i = 0; i < 3; i++){
            ninetyRight(arr);
        }
        return arr;
